      ...
      <div className="w-full max-w-[900px] min-h-[100vh] flex flex-col gap-[10px] ">
        <div className="relative bg-[white] pb-[40px] rounded shadow-lg">
          ...
          <div className="mt-[30px] pl-[20px] font-semibold text-gray-700">
            ...
            <div className="text-[16px] text-gray-500">{`${profileData.connections?.length || 0} connection`}</div>
          </div>
        ...
        <div
          className="w-full h-[100px] flex items-center p-[20px] text-[22px] text-gray-600 
        ...
        {profileData.connections?.length > 0 && (
          <div
            className="w-full min-h-[100px] flex flex-col gap-[10px] justify-center p-[20px] 
        font-semibold bg-white shadow-lg rounded-lg "
          >
            <div className="text-[22px] text-gray-600">Skills</div>
            <div className="flex flex-wrap justify-start items-center gap-[20px] text-gray-600 p-[40px] ">
              ...
              {profileData._id == userData._id && <button
                className="min-w-[150px] h-[40px] rounded-full border-2 ml-[20px]
            border-[#2dc0ff] text-[#2dc0ff] flex items-center justify-center gap-[10px]"
                onClick={() => setEdit(true)}
              >
                Add Skill
        ...
        font-semibold bg-white shadow-lg rounded-lg "
          >
            ...
            <div className="flex flex-col justify-start items-start gap-[20px] text-gray-600 p-[40px] ">
              ...
              {profileData._id == userData._id && <button
                className="min-w-[150px] h-[40px] rounded-full border-2
            border-[#2dc0ff] text-[#2dc0ff] flex items-center justify-center gap-[10px]"
                onClick={() => setEdit(true)}
              >
                Education
          ...
          >
            ...
            <div className="flex flex-col justify-start items-start gap-[20px] text-gray-600 p-[40px] ">
              {profileData.experience.map((ex) => (
                <>
                  <div className="text-[20px]">Ttile: {ex.title}</div>
