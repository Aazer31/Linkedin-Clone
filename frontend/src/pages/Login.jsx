...
function Login() {
  ...
  return (
    <div className="w-full h-screen bg-white flex flex-col items-center justify-start gap-[10px]">
      ...
      <form
        className="w-[90%] max-w-[400px] h-[700px] md:shadow-xl flex flex-col 
      justify-center gap-[20px] p-[15px]"
      ...
      >
        ...
        <input
          ...
          placeholder="email"
          required
          className="w-[100%] h-[50px] border-2
        ...
        <div
          className="w-[100%] h-[50px] border-2 border-gray-600 text-gray-800 
        ...
        >
          ...
          />
          <span
            className="absolute right-[20px] top-[10px] text-[#0a66c2] font-semibold 
          cursor-pointer"
        ...
        >
          ...
          <span className="text-[#0a66c2] font-semibold">Sign Up</span>
        </p>
      </form>
    </div>
  );
